...
780s后找到gap为0.0001%的最优解，求解时间是比较长的，在实际应用中，车辆调度次数比较频繁，约束更复杂，因此往往采用启发式算法来实现，能比较快的找到一个次优解。

```
Explored 2030160 nodes (44924205 simplex iterations) in 785.52 seconds (804.05 work units)
Thread count was 8 (of 8 available processors)

Solution count 10: 657.117 657.117 670.399 ... 982.517

Optimal solution found (tolerance 1.00e-04)
Best objective 6.571173165473e+02, best bound 6.571166260511e+02, gap 0.0001%
Gurobi status= 2
Optimal
```
